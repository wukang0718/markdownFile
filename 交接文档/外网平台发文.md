...
![image-20200827130732453](https://raw.githubusercontent.com/wukang0718/mdImage/master/images/202008/27/130734-192620.png?token=AKCNZH6B5XS6EU7E2G5DUQS7I475K)

key 的值是和后台协商好的，对登录的用户名、密码、所有接口的数据验签都是使用这个key加密。后端使用相同的 key 解密，可以验证接口是否合法，还有对存储在 cookie 中的数据，也是经过加密之后存储的，使用的是同样的加密方式。
